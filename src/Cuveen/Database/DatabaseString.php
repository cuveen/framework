 ...
 * @example DatabaseString::str_replace_outside_quotes('?', '%s', 'columnA = "Hello?" AND columnB = ?');
 * @example DatabaseString::value('columnA = "Hello?" AND columnB = ?')->replace_outside_quotes('?', '%s');
