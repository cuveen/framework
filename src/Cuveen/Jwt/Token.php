...
namespace Cuveen\Jwt;

use Cuveen\Jwt\Build;
use Cuveen\Jwt\Parse;
use Cuveen\Jwt\Jwt;
use Cuveen\Jwt\Validate;
use Cuveen\Jwt\Secret;
use Cuveen\Jwt\Encode;
use Cuveen\Jwt\Exception\ValidateException;
...
class Token
{
    ...
    /**
     * Factory method to return an instance of the Cuveen\Jwt\Build class.
     *
     * @return Build
     */
    ...
    /**
     * Factory method to return instance of the Cuveen\Jwt\Parse class.
     *
     * @return Parse
     */
