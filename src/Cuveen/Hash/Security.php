...
class Security {
     ...
     * @var	string
     */
    protected $_csrf_token_name =	'cuveen_csrf_token';
     ...
     * @var	string
     */
    protected $_csrf_cookie_name =	'cuveen_csrf_token_cookie';
    ...
    public function __construct()
    {
        ...
        $token_lifetime = (!empty($this->config->get('csrf.lifetime')))?(int)$this->config->get('csrf.lifetime'):120;
        $this->_csrf_expire = $token_lifetime*60;
        $this->_csrf_set_hash();
//        $this->csrf_verify();
        self::$_instance = $this;
    }
    ...
    {
        throw new \Exception('The action you have requested is not allowed.', 403);
    }
