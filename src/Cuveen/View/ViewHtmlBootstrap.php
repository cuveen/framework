 ...
 */
trait ViewHtmlBootstrap
{
    use ViewHtml {
        ViewHtml::select as selectParent;
        ViewHtml::input as inputParent;
        ViewHtml::commandButton as commandButtonParent;
        ViewHtml::textArea as textAreaParent;
        ViewHtml::item as itemParent;
        ViewHtml::checkbox as checkboxParent;
        ViewHtml::compileEndCheckbox as compileEndCheckboxParent;
        ViewHtml::radio as radioParent;
        ViewHtml::compileEndRadio as compileEndRadioParent;
    }
